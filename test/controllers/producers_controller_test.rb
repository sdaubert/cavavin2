...
class ProducersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producer" do
    assert_difference('Producer.count') do
      post producers_url, params: { producer: { address: @producer.address, city: @producer.city, country_id: @producer.country_id, email: @producer.email, name: @producer.name, notes: @producer.notes, phone: @producer.phone, web: @producer.web, zip: @producer.zip } }
    end
  ...
  test "should update producer" do
    patch producer_url(@producer), params: { producer: { address: @producer.address, city: @producer.city, country_id: @producer.country_id, email: @producer.email, name: @producer.name, notes: @producer.notes, phone: @producer.phone, web: @producer.web, zip: @producer.zip } }
